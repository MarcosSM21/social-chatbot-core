...
class ChatOrchestrator:
    ...
    def handle_message(self, message: ChatMessage, session_id: str, platform: str, external_user_id: str) -> ChatTurn:
        turn = self.conversation_service.process_message(message, session_id, platform=platform, external_user_id=external_user_id)
        return turn
